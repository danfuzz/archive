...
/**
 * Tan module. For each input <code>in</code>, it produces the
 * output <code>tan (in)</code>.
 *
 ...
 */
final public class Tan
extends BaseFilter
{
    /** short name */
    private static final String SHORT_NAME = "Tan";

    /** factory that creates instances of this class */
    public static final Factory FACTORY = 
	new FilterFactory (SHORT_NAME, Tan.class);
     ...
     */
    public Tan (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (Math.tan (myInPort.getDouble ()));
    }
