...
/**
 * Neg module. For each input <code>in</code>, it produces the
 * output <code>-in</code>, that is, the output is the same as the
 * input except that the sign is reversed.
 *
...
{
    /** short name */
    private static final String SHORT_NAME = "Neg";

    /** factory that creates instances of this class */
    public static final Factory FACTORY = 
	new FilterFactory (SHORT_NAME, Neg.class);
     ...
     */
    public Neg (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (-myInPort.getDouble ());
    }
