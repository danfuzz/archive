...
/**
 * Exp module. For each input <code>in</code>, it produces the
 * output <code>exp (in)</code>, that is, the mathematical constant
 * <i>e</i> (2.7...) raised to the given power.
 *
...
extends BaseFilter
{
	...
	new FilterFactory (SHORT_NAME, Exp.class);
     ...
     */
    public Exp (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (Math.exp (myInPort.getDouble ()));
    }
