...
/**
 * Floor module. For each input <code>in</code>, it produces the
 * output <code>floor (in)</code>, that is, the largest integral
 * value less than the given number.
 *
...
{
    /** short name */
    private static final String SHORT_NAME = "Floor";

    /** factory that creates instances of this class */
    public static final Factory FACTORY = 
	new FilterFactory (SHORT_NAME, Floor.class);
     ...
     */
    public Floor (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (Math.floor (myInPort.getDouble ()));
    }
