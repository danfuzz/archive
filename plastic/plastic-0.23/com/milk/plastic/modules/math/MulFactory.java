...
/**
 * A factory for multiplier modules. These take an arbitrary number of
 * inputs and multiply them together to produce a single output per
 * tick.
 *
 ...
 */
final public class MulFactory
extends BaseFactory
{
    /** short name */
    private static final String SHORT_NAME = "Mul";
	...
	return new Mul (this, template, args);
    }
}
