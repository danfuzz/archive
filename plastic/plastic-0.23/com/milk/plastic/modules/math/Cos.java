...
/**
 * Cos module. For each input <code>in</code>, it produces the
 * output <code>cos (in)</code>.
 *
 ...
 */
final public class Cos
extends BaseFilter
{
    /** short name */
    private static final String SHORT_NAME = "Cos";

    /** factory that creates instances of this class */
    public static final Factory FACTORY = 
	new FilterFactory (SHORT_NAME, Cos.class);
     ...
     */
    public Cos (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (Math.cos (myInPort.getDouble ()));
    }
