...
/**
 * Ceil module. For each input <code>in</code>, it produces the
 * output <code>ceil (in)</code>, that is, the smallest integral
 * value greater than the given number.
 *
 ...
 */
final public class Ceil
extends BaseFilter
{
    /** short name */
    private static final String SHORT_NAME = "Ceil";

    /** factory that creates instances of this class */
    public static final Factory FACTORY = 
	new FilterFactory (SHORT_NAME, Ceil.class);
     ...
     */
    public Ceil (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (Math.ceil (myInPort.getDouble ()));
    }
