...
/**
 * Acos module. For each input <code>in</code>, it produces the
 * output <code>acos (in)</code>.
 *
 ...
 */
final public class Acos
extends BaseFilter
{
    /** short name */
    private static final String SHORT_NAME = "Acos";

    /** factory that creates instances of this class */
    public static final Factory FACTORY = 
	new FilterFactory (SHORT_NAME, Acos.class);
     ...
     */
    public Acos (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (Math.acos (myInPort.getDouble ()));
    }
