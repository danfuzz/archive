...
/**
 * Round module. For each input <code>in</code>, it produces the
 * output <code>round (in)</code>, that is, the closest integral
 * value to the given number.
 *
 ...
 */
final public class Round
extends BaseFilter
{
    /** short name */
    private static final String SHORT_NAME = "Round";

    /** factory that creates instances of this class */
    public static final Factory FACTORY = 
	new FilterFactory (SHORT_NAME, Round.class);
     ...
     */
    public Round (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (Math.round (myInPort.getDouble ()));
    }
