...
/**
 * Abs module. For each input <code>in</code>, it produces the
 * output <code>abs (in)</code>.
 *
 ...
 */
final public class Abs
extends BaseFilter
{
    /** short name */
    private static final String SHORT_NAME = "Abs";

    /** factory that creates instances of this class */
    public static final Factory FACTORY = 
	new FilterFactory (SHORT_NAME, Abs.class);
     ...
     */
    public Abs (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (Math.abs (myInPort.getDouble ()));
    }
