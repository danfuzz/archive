...
/**
 * Sin module. For each input <code>in</code>, it produces the
 * output <code>sin (in)</code>.
 *
 ...
 */
final public class Sin
extends BaseFilter
{
    /** short name */
    private static final String SHORT_NAME = "Sin";

    /** factory that creates instances of this class */
    public static final Factory FACTORY = 
	new FilterFactory (SHORT_NAME, Sin.class);
     ...
     */
    public Sin (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (Math.sin (myInPort.getDouble ()));
    }
