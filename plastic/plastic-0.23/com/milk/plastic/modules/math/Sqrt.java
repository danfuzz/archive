...
/**
 * Sqrt module. For each input <code>in</code>, it produces the
 * output <code>sqrt (in)</code>.
 *
...
{
    /** short name */
    private static final String SHORT_NAME = "Sqrt";

    /** factory that creates instances of this class */
    public static final Factory FACTORY = 
	new FilterFactory (SHORT_NAME, Sqrt.class);
     ...
     */
    public Sqrt (Factory factory, Template template, Map args)
    {
    ...
    public void tick ()
    {
	myOutPort.setDouble (Math.sqrt (myInPort.getDouble ()));
    }
