...
/**
 * Module for output to an audio file with one channel of 8 bits per
 * sample.
 *
 ...
 */
final public class AudioFileOut8BitMono
extends BaseModule
{
     ...
     */
    public AudioFileOut8BitMono (Factory factory, Template template, 
				 Map args)
    {
    ...
    public void tick ()
    {
	byte value = (byte) (myInPort.getDouble () * 127);
