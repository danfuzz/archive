...
/**
 * Module for output to an audio file with two channels of 16 bits per
 * sample.
 *
 ...
 */
final public class AudioFileOut16BitStereo
extends BaseModule
{
     ...
     */
    public AudioFileOut16BitStereo (Factory factory, Template template, 
				    Map args)
    {
