 ...
 */
final public class AudioFileInMono
extends BaseModule
{
     ...
     */
    public AudioFileInMono (Factory factory, Template template, Map args)
    {
	...
	myOutPort = (DoublePort) getField ("out_0");
    }
	...
	int value = ((int) buf[0] & 0xff) + (((int) buf[1]) << 8);

	myOutPort.setDouble ((double) (value / 32767.0));
    }
