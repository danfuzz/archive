...
extends BaseModule
{
     ...
     */
    public DebugSink (Factory factory, Template template, Map args)
	...
	{
	    String inName = "in_" + i;
	    Ref newRef = ((Ref) getField (inName)).withType (Port.class);
    ...
    public void tick ()
    {
	System.err.print (myLabel);
	System.err.print (':');

	for (int i = 0; i < myCount; i++)
	{
	    System.err.print (' ');
	    System.err.print (myInputs[i].getString ());
	}
